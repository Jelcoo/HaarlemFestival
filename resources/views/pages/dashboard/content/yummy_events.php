...
<!-- Search & Sort -->
<form method="GET" action="/dashboard/events/yummy" class="mb-3 d-block d-md-flex justify-content-between align-items-center">
    <!-- Search -->
                ...
                <?php foreach ($events as $event) { ?>
                    <tr>
                        ...
                        <td class="d-flex gap-2">
                            <a href="/dashboard/events/yummy/edit?id=<?php echo $event->id; ?>" class="btn btn-warning btn-sm">Edit</a>
